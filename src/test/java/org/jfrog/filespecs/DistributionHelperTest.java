        ...
        return new Object[][]{{
                ...
                Collections.singletonList(
                        new DistributionSpecComponent(
                                "items.find({\"$or\":[{\"$and\":[{\"repo\":\"repo-local\",\"path\":\".\",\"name\":\"file.sfx\"}]}]}).include(\"name\",\"repo\",\"path\",\"actual_md5\",\"actual_sha1\",\"size\",\"type\",\"modified\",\"created\",\"property\")",
                                new ArrayList<>(),
                                new ArrayList<>())
                )
        }, {
                ...
                Collections.singletonList(
                        new DistributionSpecComponent(
                                "items.find({\"path\":{\"$ne\":\".\"},\"$or\":[{\"$and\":[{\"repo\":\"a\",\"path\":\"b\",\"name\":\"c\"}]}]}).include(\"name\",\"repo\",\"path\",\"actual_md5\",\"actual_sha1\",\"size\",\"type\",\"modified\",\"created\",\"property\")",
                ...
                Arrays.asList(
                        new DistributionSpecComponent(
                                "items.find({\"path\":{\"$ne\":\".\"},\"$or\":[{\"$and\":[{\"repo\":\"a\",\"path\":{\"$match\":\"*/c\"},\"name\":{\"$match\":\"*\"}}]},{\"$and\":[{\"repo\":\"a\",\"path\":{\"$match\":\"*/c/*\"},\"name\":{\"$match\":\"*\"}}]}]}).include(\"name\",\"repo\",\"path\",\"actual_md5\",\"actual_sha1\",\"size\",\"type\",\"modified\",\"created\",\"property\")",
                ...
                Collections.singletonList(
                        new DistributionSpecComponent(
                                "items.find({\"repo\":\"a\",\"path\":\"b\",\"name\":\"c\"}).include(\"name\",\"repo\",\"path\",\"actual_md5\",\"actual_sha1\",\"size\",\"type\",\"modified\",\"created\",\"property\")",
